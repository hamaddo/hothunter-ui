...
export const JobRequestApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        jobRequestIdPut: async (id: string, jobRequest?: JobRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const JobRequestApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async jobRequestIdDelete(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Client>> {
         ...
         * @throws {RequiredError}
         */
        async jobRequestIdPut(id: string, jobRequest?: JobRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobRequest>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.jobRequestIdPut(id, jobRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const JobRequestApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        jobRequestIdDelete(id: string, options?: any): AxiosPromise<Client> {
         ...
         * @throws {RequiredError}
         */
        jobRequestIdPut(id: string, jobRequest?: JobRequest, options?: any): AxiosPromise<JobRequest> {
            return localVarFp.jobRequestIdPut(id, jobRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class JobRequestApi extends BaseAPI {
    ...
    public jobRequestIdPut(requestParameters: JobRequestApiJobRequestIdPutRequest, options?: AxiosRequestConfig) {
        return JobRequestApiFp(this.configuration).jobRequestIdPut(requestParameters.id, requestParameters.jobRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
